    ...
    public class Program
    {
        ...
        public static async Task CheckVars()
        {
            ...
            if (!exists)
            {
                ...
                string[] lines =
                {
                    "HMDBat = HMDBat", "ControllerBatL = ControllerBatL", "ControllerBatR = ControllerBatR", "Eyesmode = /avatar/parameters/Eyes mode", "Eyesmode_test = /avatar/parameters/Eyes_mode"
                };
